package com.ach.memories_back.config;
...
import com.ach.memories_back.filter.JwtAuthenticationFilter;
import com.ach.memories_back.handler.OAuth2SuccessHandler;
import com.ach.memories_back.service.implement.OAuth2UserServiceImplement;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        security
            ...
            // description: csrt 취약점 대비 미사용 지정 //
            ...
            .requestMatchers("/api/v1/dairy", "/api/v1/diary/**").authenticated()
