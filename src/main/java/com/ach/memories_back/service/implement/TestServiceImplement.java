...
import com.ach.memories_back.common.entity.ConcentrationTestEntity;
import com.ach.memories_back.common.entity.MemoryTestEntity;
import com.ach.memories_back.repository.ConcentrationTestRepository;
import com.ach.memories_back.repository.MemoryTestRepository;
import com.ach.memories_back.service.TestService;
...
public class TestServiceImplement implements TestService {
    ...
    public ResponseEntity<ResponseDto> postConcentration(PostConcentrationRequestDto dto, String userId) {
        ...
        try {
            ...
            Integer preSquence = concentrationTestRepository.countByUserId(userId);

            if (preSquence == 0) {
                concentrationTestEntity = new ConcentrationTestEntity(dto, userId);
            }
            else {
                ConcentrationTestEntity preConcentrationTestEntity = concentrationTestRepository.findByUserIdAndSequence(userId, preSquence);
