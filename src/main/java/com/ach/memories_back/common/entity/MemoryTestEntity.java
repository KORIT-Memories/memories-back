package com.ach.memories_back.common.entity;

import java.time.LocalDateTime;
import java.time.format.DateTimeFormatter;

import com.ach.memories_back.common.dto.request.test.PostMemoryRequestDto;
import com.ach.memories_back.common.entity.pk.MemoryTestPk;
...
public class MemoryTestEntity {
    ...
    public MemoryTestEntity(PostMemoryRequestDto dto, MemoryTestEntity preEntity, String userId) {
        ...
        this.measurementTime = dto.getMeasurementTime();
        this.testDate = now.format(dateTimeFormatter);
        this.gap = this.measurementTime - preEntity.getMeasurementTime();
    }
